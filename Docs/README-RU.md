...
| `ApplicationDirectory`   | Библиотека обнаружена в директории анализируемого приложения |
...
| `CurrentDirectory`       | Библиотека обнаружена в текущей рабочей директории           |
...
Также Consyzer может показать эвристические совпадения — например, библиотеку рядом с анализируемым файлом.
